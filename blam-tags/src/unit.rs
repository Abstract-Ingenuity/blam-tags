...
#[repr(u32)]
pub enum UnitFlags {
    // Full 30-flag H3 layout the .unit-bearing tags carry (bits 0-29). MCC
    // pruned 8 (half-speed interpolation, entrance inside bounding sphere,
    // impact melee attaches to unit, impact melee dies on shields, melee
    // attackers cannot attach, shields fry infection forms, unused0,
    // unused1) and ADDED "use velocity as acceleration". Superset = the H3
    // layout at its real bit positions + the MCC-only flag appended at 30.
    #[strum(serialize = "circular aiming")] CircularAiming = 0,
    #[strum(serialize = "destroyed after dying")] DestroyedAfterDying = 1,
    #[strum(serialize = "half-speed interpolation")] HalfSpeedInterpolation = 2,
    #[strum(serialize = "fires from camera")] FiresFromCamera = 3,
    #[strum(serialize = "entrance inside bounding sphere")] EntranceInsideBoundingSphere = 4,
    #[strum(serialize = "doesn't show readied weapon")] DoesntShowReadiedWeapon = 5,
    #[strum(serialize = "causes passenger dialogue")] CausesPassengerDialogue = 6,
    #[strum(serialize = "resists pings")] ResistsPings = 7,
    #[strum(serialize = "melee attack is fatal")] MeleeAttackIsFatal = 8,
    #[strum(serialize = "don't reface during pings")] DontRefaceDuringPings = 9,
    #[strum(serialize = "has no aiming")] HasNoAiming = 10,
    #[strum(serialize = "simple creature")] SimpleCreature = 11,
    #[strum(serialize = "impact melee attaches to unit")] ImpactMeleeAttachesToUnit = 12,
    #[strum(serialize = "impact melee dies on shields")] ImpactMeleeDiesOnShields = 13,
    #[strum(serialize = "cannot open doors automatically")] CannotOpenDoorsAutomatically = 14,
    #[strum(serialize = "melee attackers cannot attach")] MeleeAttackersCannotAttach = 15,
    #[strum(serialize = "not instantly killed by melee")] NotInstantlyKilledByMelee = 16,
    #[strum(serialize = "flashlight power doesnt transfer to weapon")] FlashlightPowerDoesntTransferToWeapon = 17,
    #[strum(serialize = "runs around flaming")] RunsAroundFlaming = 18,
    #[strum(serialize = "top level for AOE damage")] TopLevelForAoeDamage = 19,
    #[strum(serialize = "special cinematic unit")] SpecialCinematicUnit = 20,
    #[strum(serialize = "ignored by autoaiming")] IgnoredByAutoaiming = 21,
    #[strum(serialize = "shields fry infection forms")] ShieldsFryInfectionForms = 22,
    #[strum(serialize = "unused0")] Unused0 = 23,
    #[strum(serialize = "unused1")] Unused1 = 24,
    #[strum(serialize = "acts as gunner for parent")] ActsAsGunnerForParent = 25,
    #[strum(serialize = "controlled by parent gunner")] ControlledByParentGunner = 26,
    #[strum(serialize = "parent's primary weapon")] ParentsPrimaryWeapon = 27,
    #[strum(serialize = "unit has boost")] UnitHasBoost = 28,
    #[strum(serialize = "allow aim while opening or closing")] AllowAimWhileOpeningOrClosing = 29,
    #[strum(serialize = "use velocity as acceleration")] UseVelocityAsAcceleration = 30,
}
